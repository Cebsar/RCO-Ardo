...
export function SystemPage() {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-primary" /> API Health</CardTitle>
        </CardHeader>
        <CardContent>
          <Badge>{health.data.data.status}</Badge>
        </CardContent>
      </Card>
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><Server className="h-5 w-5 text-primary" /> Database</CardTitle>
        </CardHeader>
        <CardContent>
          <Badge>{health.data.data.database}</Badge>
        </CardContent>
      </Card>
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2"><ShieldCheck className="h-5 w-5 text-primary" /> API Version</CardTitle>
        </CardHeader>
