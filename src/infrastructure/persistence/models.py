...
class FactAccountingEntryORM(Base):
    ...
    debit_amount: Mapped[float | None] = mapped_column(Numeric(18, 2))
    credit_amount: Mapped[float | None] = mapped_column(Numeric(18, 2))
    source_value: Mapped[float | None] = mapped_column(Numeric(18, 2))
